...
Enny.FlowElement = function (data) {
    var self = this;
    this._ = [];
    if (Typpy(data) === "array") {
...
Enny.FlowElement.prototype.addComponent = function (data) {
    data = new Enny.FlowCompoent(data);
    this._.push(data.toFlow());
};
...
Enny.FlowComponent = function FlowComponent (data, options) {
    var self = this;
    if (Typpy(data) === "flowcomponent") {
        return data;
    }
    self.enny = options.enny;
